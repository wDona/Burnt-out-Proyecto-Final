...
@Serializable
data class Tarea(val idTarea: Int, val titulo: String, val descripcion: String?, val estado: String?, val idTableroPerteneciente: Int, val usuarioAsignado: String?, val idSubtareas: List<Int>?)
